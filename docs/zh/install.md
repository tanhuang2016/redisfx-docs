...
## Linux
Linux 平台上提供了三种发行版本，包括x86和ARM架构，其中`.rpm` 为安装版本，其安装过程与其他软件相同，`.tar.gz` 为便携版本，解压后即可运行，`.jar` 为Java原生版本，需要Java运行环境。
...
## MacOS
MacOS 平台上提供了两种发行版本，包括x86和ARM架构，其中`.dmg` 为安装版本，其安装过程与其他软件相同，`.tar.gz` 为便携版本，解压后即可运行，`.jar` 为Java原生版本，需要Java运行环境。
